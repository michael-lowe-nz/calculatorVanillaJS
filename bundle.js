...
var _sumOfArray = __webpack_require__(35);

var _sumOfArray2 = _interopRequireDefault(_sumOfArray);

var _getInputValue = __webpack_require__(36);
...
var _createStore = (0, _redux.createStore)(_reducer2.default, initialState),
...
function handleSubmit(e) {
  e.preventDefault();
  if (!isNaN((0, _getInputValue2.default)()) && (0, _getInputValue2.default)()) {
    dispatch({ type: 'ADD_NUMBER', payload: (0, _getInputValue2.default)() });
  }
  setInput("");
}
...
module.exports = function (arr) {
  return arr.length ? arr.reduce(function (previous, current) {
